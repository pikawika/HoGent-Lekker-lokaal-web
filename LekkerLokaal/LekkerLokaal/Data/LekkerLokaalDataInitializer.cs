    ...
    public class LekkerLokaalDataInitializer
    {
        ...
        public async Task InitializeData()
        {
            ...
            if (_dbContext.Database.EnsureCreated())
            {
                ...
                Bon bon05 = new Bon("Wijnproeverij BraLenBre", 45, 75, "Keuze uit verschillende wijnen vergezeld met een hapje.", 124, @"images\bon\5\", eten_drinken, "Arbeidstraat", "14", 9300, "Aalst", Handelaar05 ,Aanbieding.Geen);
