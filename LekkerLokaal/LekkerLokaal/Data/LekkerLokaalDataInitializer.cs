    ...
    public class LekkerLokaalDataInitializer
    {
        ...
        public async Task InitializeData()
        {
            ...
            if (_dbContext.Database.EnsureCreated())
            {
                ...
                Bon bon01 = new Bon("Restaurant lekker", 25, 50, "3 sterren resaurant in het centrum van Aalst.", 17, @"images\bon\1\thumb.jpg", eten_drinken, "Arbeidstraat", "14", 9300, "Aalst", Handelaar01 ,2);
                Bon bon02 = new Bon("Dessertbar chez Bontinck", 5, 30, "Met passie gemaakte dessertjes in het mooie Schellebelle.", 242, @"images\bon\2\thumb.jpg", eten_drinken, "Paepestraat", "178", 9260, "Wichelen", Handelaar02 ,0);
                Bon bon03 = new Bon("Bierspecialist Schets", 10, 20, "Meer dan 70 Belgische bieren in een gezellige kroeg.", 42, @"images\bon\3\thumb.jpg", eten_drinken, "Ravensteinstraat", "50", 1000, "Brussel", Handelaar03 ,0);
                Bon bon04 = new Bon("De Coninck's cocktail", 5, 15, "Een VIP cocktailbar met live optredens van lokale muzikanten.", 24, @"images\bon\4\thumb.jpg", eten_drinken, "Sint-Pietersnieuwstraat", "124", 9000, "Gent", Handelaar04 ,0);
                Bon bon05 = new Bon("Wijnproeverij BraLenBre", 45, 75, "Keuze uit verschillende wijnen vergezeld met een hapje.", 41, @"images\bon\5\thumb.jpg", eten_drinken, "Arbeidstraat", "14", 9300, "Aalst", Handelaar05 ,0);
                Bon bon06 = new Bon("Veggiebar 't Sandwichke", 15, 30, "Het bewijs dat vegetarisch eten lekker kan zijn.", 45, @"images\bon\6\thumb.jpg", eten_drinken, "Arbeidstraat", "14", 9300, "Aalst", Handelaar06 ,0);
                Bon bon07 = new Bon("Fastfood McDonalds", 1, 5, "De keten met keuzes voor iedereen.", 246, @"images\bon\7\thumb.jpg", eten_drinken, "Arbeidstraat", "14", 9300, "Aalst", Handelaar07 ,0);
                Bon bon08 = new Bon("Restaurant SOS Piet", 75, 150, "5 sterren restaurant met de enige echte SOS Piet als kok.", 21, @"images\bon\8\thumb.jpg", eten_drinken, "Paepestraat", "178", 9260, "Wichelen", Handelaar08 ,0);
                Bon bon09 = new Bon("Wijnproeverij CoBoSh", 25, 75, "Keuze uit verschillende wijnen vergezeld met een hapje.", 47, @"images\bon\9\thumb.jpg", eten_drinken, "Arbeidstraat", "14", 9300, "Aalst", Handelaar09 ,0);
                Bon bon10 = new Bon("Wijnproeverij chacha", 22, 75, "Hapje drankje favoriet muziekje.", 22, @"images\bon\10\thumb.jpg", eten_drinken, "Ravensteinstraat", "50", 1000, "Brussel", Handelaar10 ,0);


                Bon bon11 = new Bon("Sanitas Wichelen", 5, 30, "Ideale fitness voor oud en jong", 83, @"images\bon\11\thumb.jpg", fitness, "Paepestraat", "178", 9260, "Wichelen", Handelaar11 ,0);
                Bon bon12 = new Bon("Fitness Basic-Fit Aalst", 5, 30, "Bekenste fitness van België met vestigingen over het hele land.", 75, @"images\bon\12\thumb.jpg", fitness, "Arbeidstraat", "14", 9300, "Aalst", Handelaar12 ,0);
                Bon bon13 = new Bon("Fitness Basic-Fit Gent", 4, 30, "Bekenste fitness van België met vestigingen over het hele land.", 8, @"images\bon\13\thumb.jpg", fitness, "Sint-Pietersnieuwstraat", "124", 9000, "Gent", Handelaar12 ,0);
                Bon bon14 = new Bon("Fitness Basic-Fit Brussel", 6, 30, "Bekenste fitness van België met vestigingen over het hele land.", 53, @"images\bon\14\thumb.jpg", fitness, "Ravensteinstraat", "50", 1000, "Brussel", Handelaar12 ,0);
                Bon bon15 = new Bon("Fitness Basic-Fit Brugge", 8, 30, "Bekenste fitness van België met vestigingen over het hele land.", 53, @"images\bon\15\thumb.jpg", fitness, "Maalse Steenweg", "50", 8310, "Brugge", Handelaar12 ,0);
                Bon bon16 = new Bon("Fitness Basic-Fit Sint-Truiden", 5, 30, "Bekenste fitness van België met vestigingen over het hele land.", 72, @"images\bon\16\thumb.jpg", fitness, "Luikersteenweg ", "40", 3800, "Sint-Truiden", Handelaar12 ,0);
                Bon bon17 = new Bon("Fitness Basic-Fit Wetteren", 6, 30, "Bekenste fitness van België met vestigingen over het hele land.", 65, @"images\bon\17\thumb.jpg", fitness, "Cooppallaan ", "40", 9230, "Wetteren", Handelaar12 ,0);
                Bon bon18 = new Bon("Fitness Basic-Fit Wichelen", 4, 30, "Bekenste fitness van België met vestigingen over het hele land.", 22, @"images\bon\18\thumb.jpg", fitness, "Paepestraat", "178", 9260, "Wichelen", Handelaar12 ,1);
                Bon bon19 = new Bon("Fitness Basic-Fit Lede", 8, 30, "Bekenste fitness van België met vestigingen over het hele land.", 75, @"images\bon\19\thumb.jpg", fitness, "Kasteeldreef", "15", 9340, "Lede", Handelaar12 ,0);


                Bon bon20 = new Bon("Nachtwandeling Aalst at night", 5, 10, "Geniet van de sterrenhemel in de mooie streken van Aalst (met gids).", 63, @"images\bon\20\thumb.jpg", uitstappen, "Arbeidstraat", "14", 9300, "Aalst", Handelaar21 ,0);
                Bon bon21 = new Bon("Dagje wallibi in Dendermonde", 25, 142, "Wat is er nu leuker dan een dagje wallibi met vrienden", 34, @"images\bon\21\thumb.jpg", uitstappen, "Mechelsesteenweg ", "138", 9200, "Dendermonde", Handelaar22 ,0);
                Bon bon22 = new Bon("Met de trein naar Oostende", 36, 159, "Spring zong er al over dus wat houd je tegen het te doen", 45, @"images\bon\22\thumb.jpg", uitstappen, "Torhoutsesteenweg", "611", 8400, "Oostende", Handelaar23 ,0);
                Bon bon23 = new Bon("Weekendje disneyland parijs", 29, 251, "Disneyland de bestemming voor groot en klein", 35, @"images\bon\23\thumb.jpg", uitstappen, "Leopoldlaan", "1", 1930, "Zaventem", Handelaar24 ,0);
                Bon bon24 = new Bon("De grotten van Han", 50, 264, "Het liedje zit ongetwijfeld al in je hoofd dus ga nu gewoon", 86, @"images\bon\24\thumb.jpg", uitstappen, "Rue Joseph Lamotte", "2", 5580, "Han-sur-Lesse", Handelaar25 ,0);
                Bon bon25 = new Bon("Historisch bezoek Breemdonk", 6, 185, "Voor de oorlog fanaten een must", 35, @"images\bon\25\thumb.jpg", uitstappen, "Brandstraat", "57", 2830, "Willebroek", Handelaar26 ,0);


                Bon bon26 = new Bon("Bloemencenter Brenk", 1, 35, "Stel zelf uw setje bloemen samen met deze bon.", 43, @"images\bon\26\thumb.jpg", huis_tuin, "Arbeidstraat", "14", 9300, "Aalst", Handelaar31 ,0);
                Bon bon27 = new Bon("Potgrond De Mol in Lede", 22, 233, "Heb je grond nodig voor in een pot", 68, @"images\bon\27\thumb.jpg", huis_tuin, "Kasteeldreef", "15", 9340, "Lede", Handelaar32 ,0);
                Bon bon28 = new Bon("Schelfhout Ten Aalst", 36, 345, "Schelfhout, waar moet je andes zijn!", 75, @"images\bon\28\thumb.jpg", huis_tuin, "Arbeidstraat", "14", 9300, "Aalst", Handelaar33 ,0);
                Bon bon29 = new Bon("Bloemetje liesje in Gent", 13, 468, "Lies, verkoopt ook wel een madelief ", 25, @"images\bon\29\thumb.jpg", huis_tuin, "Sint-Pietersnieuwstraat", "124", 9000, "Gent", Handelaar34 ,1);
                Bon bon30 = new Bon("Funa Lima tuincentrum Lede", 26, 232, "Vissen, fonteinen, dieraccesoire...", 14, @"images\bon\30\thumb.jpg", huis_tuin, "Kasteeldreef", "15", 9340, "Lede", Handelaar35 ,0);
                Bon bon31 = new Bon("Vijvervoorziening Blub", 30, 404, "Blub, de winkel voor vis enthousiasten", 35, @"images\bon\31\thumb.jpg", huis_tuin, "Arbeidstraat", "14", 9300, "Aalst", Handelaar36 ,0);
                Bon bon32 = new Bon("Grasmaaiers Bontinck", 25, 89, "Jaren ervaring in het snoeien", 76, @"images\bon\32\thumb.jpg", huis_tuin, "Paepestraat", "178", 9260, "Wichelen", Handelaar37 ,0);
                Bon bon33 = new Bon("Aveve boerenbond te Aalst", 31, 416, "Bij de boerenbond vind je altijd wat je zoekt", 75, @"images\bon\33\thumb.jpg", huis_tuin, "Arbeidstraat", "14", 9300, "Aalst", Handelaar38 ,0);
                Bon bon34 = new Bon("Groener Gras In Wetteren", 12, 526, "Gazon voorzieningen", 14, @"images\bon\34\thumb.jpg", huis_tuin, "Cooppallaan ", "40", 9230, "Wetteren", Handelaar39 ,0);

                Bon bon35 = new Bon("Pukkelpop weekend tickets", 21, 513, "Pukkelpop, dat moet je gedaan hebben", 57, @"images\bon\35\thumb.jpg", events, "Paepestraat", "178", 9260, "Wichelen", Handelaar41 ,0);
                Bon bon36 = new Bon("Lokerse bierfeesten", 44, 393, "Bierfanaten kunnen dit niet missen", 75, @"images\bon\36\thumb.jpg", events, "Kleine Dam", "1", 9160, "Lokeren", Handelaar42 ,0);
                Bon bon37 = new Bon("Gentse feesten eetfestijn", 42, 464, "Drinken en eten, meer moet dat niet zijn", 25, @"images\bon\37\thumb.jpg", events, "Sint-Pietersnieuwstraat", "124", 9000, "Gent", Handelaar43 ,0);
                Bon bon38 = new Bon("Gameforce in de Nekkerhalle", 38, 179, "Voor elke nerd wat wils", 14, @"images\bon\38\thumb.jpg", events, "Ravensteinstraat", "50", 1000, "Brussel", Handelaar44 ,0);
                Bon bon39 = new Bon("Drive A Ferrari Day", 8, 318, "Ideal geshenk voor een autofanaat", 38, @"images\bon\39\thumb.jpg", events, "Paepestraat", "178", 9260, "Wichelen", Handelaar45 ,0);
                Bon bon40 = new Bon("Facts: trein en eten", 34, 197, "Cosplay, eten en vervoer", 18, @"images\bon\40\thumb.jpg", events, "Sint-Pietersnieuwstraat", "124", 9000, "Gent", Handelaar46 ,0);

                Bon bon41 = new Bon("Makeup pallete Nude", 29, 374, "Het bekendste merk zijn palette", 67, @"images\bon\41\thumb.jpg", beauty, "Paepestraat", "178", 9260, "Wichelen", Handelaar51 ,0);
                Bon bon42 = new Bon("Ici Paris verwenbon", 15, 500, "Een parfum kan je nooit mee misdoen", 17, @"images\bon\42\thumb.jpg", beauty, "Arbeidstraat", "14", 9300, "Aalst", Handelaar52 ,1);
                Bon bon43 = new Bon("Lipstick Lover Aalst", 8, 404, "Voor de lippen lovers", 86, @"images\bon\43\thumb.jpg", beauty, "Arbeidstraat", "14", 9300, "Aalst", Handelaar53 ,0);

                Bon bon44 = new Bon("Sofa en Co", 18, 389, "Relax in een sofa van sofa en co", 71, @"images\bon\44\thumb.jpg", interieur, "Arbeidstraat", "14", 9300, "Aalst", Handelaar61 ,0);
                Bon bon45 = new Bon("Deba meubelen", 36, 202, "Verkoopt al uw interieur", 37, @"images\bon\45\thumb.jpg", interieur, "Arbeidstraat", "14", 9300, "Aalst", Handelaar62 ,0);
                Bon bon46 = new Bon("Ikea huisvoorzieningeb", 40, 375, "Meubelspiaclist sinds 74", 71, @"images\bon\46\thumb.jpg", interieur, "Paepestraat", "178", 9260, "Wichelen", Handelaar63 ,0);
                Bon bon47 = new Bon("Leenbakker", 34, 335, "Om te kopen, niet te lenen", 37, @"images\bon\47\thumb.jpg", interieur, "Sint-Pietersnieuwstraat", "124", 9000, "Gent", Handelaar64 ,0);
                Bon bon48 = new Bon("Salon Ballon Gent", 13, 352, "Sallon Ballon is een speciaalzaak te Gent", 76, @"images\bon\48\thumb.jpg", interieur, "Sint-Pietersnieuwstraat", "124", 9000, "Gent", Handelaar65 ,0);
                Bon bon49 = new Bon("Keukens Donald", 45, 244, "Al 8 jaar maak ik keukens alsof ze voor mezelf zijn", 46, @"images\bon\49\thumb.jpg", interieur, "Arbeidstraat", "14", 9300, "Aalst", Handelaar66 ,0);
                Bon bon50 = new Bon("Modern Gent", 31, 510, "Modern interieur hoeft niet duur te zijn", 75, @"images\bon\50\thumb.jpg", interieur, "Sint-Pietersnieuwstraat", "124", 9000, "Gent", Handelaar67 ,0);
                Bon bon51 = new Bon("Kunst & Kitch", 18, 186, "Een beetje kunst, een beetje kitch", 46, @"images\bon\51\thumb.jpg", interieur, "Paepestraat", "178", 9260, "Wichelen", Handelaar68 ,0);
                Bon bon52 = new Bon("Moderne interieur Gill", 5, 60, "Op maat gemaakt interieur tegen een zacht prijsje", 45, @"images\bon\52\thumb.jpg", interieur, "Arbeidstraat", "14", 9300, "Aalst", Handelaar69 ,1);

                Bon bon53 = new Bon("C&A Aalst", 24, 480, "De kledingwinkel in Aalst en omstreken", 42, @"images\bon\53\thumb.jpg", kledij, "Arbeidstraat", "14", 9300, "Aalst", Handelaar71 ,0);
                Bon bon54 = new Bon("AS Advantures", 48, 373, "Kledie om een avontuur mee aan te gaan", 47, @"images\bon\54\thumb.jpg", kledij, "Paepestraat", "178", 9260, "Wichelen", Handelaar72 ,0);
                Bon bon55 = new Bon("Ultra Wet", 41, 413, "De kledingspecialist voor droog en nat", 71, @"images\bon\55\thumb.jpg", kledij, "Arbeidstraat", "14", 9300, "Aalst", Handelaar73 ,0);
                Bon bon56 = new Bon("Holiday", 24, 489, "Voor al uw feestkledij", 17, @"images\bon\56\thumb.jpg", kledij, "Sint-Pietersnieuwstraat", "124", 9000, "Gent", Handelaar74 ,0);
                Bon bon57 = new Bon("Bram's Fashion", 23, 86, "Voor ieder wat wilds", 73, @"images\bon\57\thumb.jpg", kledij, "Paepestraat", "178", 9260, "Wichelen", Handelaar75 ,0);
                Bon bon58 = new Bon("Bontinck's Panthers", 30, 453, "Pants from Bontinck are dreams for legs", 72, @"images\bon\58\thumb.jpg", kledij, "Arbeidstraat", "14", 9300, "Aalst", Handelaar76 ,0);
                Bon bon59 = new Bon("Bre Bra", 29, 478, "Van A tot Z, u vindt het bij ons", 92, @"images\bon\59\thumb.jpg", kledij, "Sint-Pietersnieuwstraat", "124", 9000, "Gent", Handelaar77 ,0);
                Bon bon60 = new Bon("Pikantje", 34, 402, "Erotische kledingwinkel", 9, @"images\bon\60\thumb.jpg", kledij, "Arbeidstraat", "14", 9300, "Aalst", Handelaar78 ,1);

                Bon bon61 = new Bon("Fnac Aalst", 3, 377, "De multimedia specialist in Europa", 54, @"images\bon\61\thumb.jpg", multimedia, "Arbeidstraat", "14", 9300, "Aalst", Handelaar81 ,0);
                Bon bon62 = new Bon("Mediamarkt Dendermonde", 46, 433, "Electronica tegen een spot prijs", 45, @"images\bon\62\thumb.jpg", multimedia, "Mechelsesteenweg", "138", 9200, "Dendermonde", Handelaar82 ,0);
                Bon bon63 = new Bon("Van Den Borre Gent", 31, 181, "Koffiezets voor 12€", 15, @"images\bon\63\thumb.jpg", multimedia, "Sint-Pietersnieuwstraat", "124", 9000, "Gent", Handelaar83 ,0);
                Bon bon64 = new Bon("Bontinck IT brugge", 36, 539, "Een probleempje groot of klein, dan moet je bij IT Lennert zijn", 67, @"images\bon\64\thumb.jpg", multimedia, "Maalse Steenweg", "50", 8310, "Brugge", Handelaar84 ,0);
                Bon bon65 = new Bon("Schets Apple Premium", 49, 124, "U vindt alle laatste Apple producten hier", 78, @"images\bon\65\thumb.jpg", multimedia, "Paepestraat", "178", 9260, "Wichelen", Handelaar85 ,0);
                Bon bon66 = new Bon("Lab9 Aalst", 7, 340, "Officiele Apple reseller", 64, @"images\bon\66\thumb.jpg", multimedia, "Arbeidstraat", "14", 9300, "Aalst", Handelaar86 ,0);
                Bon bon67 = new Bon("De Conincks Screen Repair", 38, 536, "Een ongelukje is rap gebeurd", 75, @"images\bon\67\thumb.jpg", multimedia, "Paepestraat", "178", 9260, "Wichelen", Handelaar87 ,0);
                Bon bon68 = new Bon("Medion Custom", 40, 316, "Medion laptop op maat gemaakt", 24, @"images\bon\68\thumb.jpg", multimedia, "Sint-Pietersnieuwstraat", "124", 9000, "Gent", Handelaar88 ,0);
                Bon bon69 = new Bon("Dell Dinosaur", 27, 311, "MS Dos specialist", 30, @"images\bon\69\thumb.jpg", multimedia, "Paepestraat", "178", 9260, "Wichelen", Handelaar89 ,0);


                Bon bon70 = new Bon("Generieke cadeaubon", 1, 50, "Niet zeker welke bon u juist wilt, dan is deze generieke bon iets voor u!", 457, @"images\bon\70\thumb.jpg", generiek, "Arbeidstraat", "14", 9300, "Aalst", Handelaar91 ,2);
