    ...
    public class LekkerLokaalDataInitializer
    {
        ...
        public async Task InitializeData()
        {
            ...
            if (_dbContext.Database.EnsureCreated())
            {
                ...
                Bon bon01 = new Bon("Restaurant lekker", 25, 50, "3 sterren resaurant in het centrum van Aalst.", 17, @"images\bon\1\", eten_drinken, "Arbeidstraat", "14", 9300, "Aalst", Handelaar01 ,Aanbieding.Speciaal);
                Bon bon02 = new Bon("Dessertbar chez Bontinck", 5, 30, "Met passie gemaakte dessertjes in het mooie Schellebelle.", 242, @"images\bon\2\", eten_drinken, "Paepestraat", "178", 9260, "Wichelen", Handelaar02 ,Aanbieding.Geen);
                ...
                Bon bon05 = new Bon("Wijnproeverij BraLenBre", 45, 75, "Keuze uit verschillende wijnen vergezeld met een hapje.", 41, @"images\bon\5\", eten_drinken, "Arbeidstraat", "14", 9300, "Aalst", Handelaar05 ,Aanbieding.Geen);
                ...
                Bon bon07 = new Bon("Fastfood McDonalds", 1, 5, "De keten met keuzes voor iedereen.", 246, @"images\bon\7\", eten_drinken, "Arbeidstraat", "14", 9300, "Aalst", Handelaar07 ,Aanbieding.Geen);
                ...
                Bon bon18 = new Bon("Fitness Basic-Fit Wichelen", 4, 30, "Bekenste fitness van België met vestigingen over het hele land.", 22, @"images\bon\18\", fitness, "Paepestraat", "178", 9260, "Wichelen", Handelaar12 ,Aanbieding.Standaard);
                ...
                Bon bon29 = new Bon("Bloemetje liesje in Gent", 13, 468, "Lies, verkoopt ook wel een madelief ", 25, @"images\bon\29\", huis_tuin, "Sint-Pietersnieuwstraat", "124", 9000, "Gent", Handelaar34 ,Aanbieding.Standaard);
                ...
                Bon bon42 = new Bon("Ici Paris verwenbon", 15, 500, "Een parfum kan je nooit mee misdoen", 17, @"images\bon\42\", beauty, "Arbeidstraat", "14", 9300, "Aalst", Handelaar52 ,Aanbieding.Standaard);
                ...
                Bon bon52 = new Bon("Moderne interieur Gill", 5, 60, "Op maat gemaakt interieur tegen een zacht prijsje", 45, @"images\bon\52\", interieur, "Arbeidstraat", "14", 9300, "Aalst", Handelaar69 ,Aanbieding.Standaard);
                ...
                Bon bon64 = new Bon("Bontinck IT brugge", 36, 539, "Een probleempje groot of klein, dan moet je bij IT Lennert zijn", 67, @"images\bon\64\", multimedia, "Maalse Steenweg", "50", 8310, "Brugge", Handelaar84 ,Aanbieding.Geen);
